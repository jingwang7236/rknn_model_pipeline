...
resnet_result inference_rec_person_resnet18_model_opencv(rknn_app_context_t *app_ctx, det_model_input input_data, cls_model_inference_params params_, bool enable_logger)
{
    resnet_result od_results;
    memset(&od_results, 0, sizeof(resnet_result));
