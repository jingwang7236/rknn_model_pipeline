...
static int post_process_retinanet(rknn_app_context_t *app_ctx, cv::Mat src_img, rknn_output outputs[], retinaface_result *result, letterbox_four *letter_box, const int num_class) 
{
