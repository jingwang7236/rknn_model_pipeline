...
object_detect_result_list inference_det_gun_model(rknn_app_context_t* app_ctx, det_model_input input_data, bool enable_logger);
object_detect_result_list inference_det_stat_door_model(rknn_app_context_t* app_ctx, det_model_input input_data, bool enable_logger);
